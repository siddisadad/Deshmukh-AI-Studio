...
**Release:** [CHANGELOG.md](CHANGELOG.md) — tag `v0.2.28-beta` adds federated Grafana dashboards and Loki ruler fan-out; `v0.2.27-beta` added Stripe metered prices sync.
