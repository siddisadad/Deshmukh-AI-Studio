...
| Item | Status on `main` | Next depth |
|---|---|---|
| Code metadata RAG | Manifest API + `CODE_FILE` indexing ([63-CODE-METADATA-RAG-GUIDE.md](63-CODE-METADATA-RAG-GUIDE.md)), Git sync + webhook reindex ([64-GIT-CODE-METADATA-SYNC-GUIDE.md](64-GIT-CODE-METADATA-SYNC-GUIDE.md)), GitLab/Bitbucket connectors ([65-GITLAB-BITBUCKET-SYNC-GUIDE.md](65-GITLAB-BITBUCKET-SYNC-GUIDE.md)) | — |
