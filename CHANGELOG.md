...
- Org git sync overview preset counts — match counts on built-in overview filter chips
- `GET .../git-sync-overview/filter-counts` API
- `docs/110-ORG-GIT-SYNC-OVERVIEW-PRESET-COUNTS-GUIDE.md`, Phase 42 roadmap
...
- Org sync run active filter chips — removable per-dimension run filter indicators
- `docs/106-ORG-GIT-SYNC-RUN-ACTIVE-FILTER-CHIPS-GUIDE.md`, Phase 38 roadmap
...
- Org bulk disable scheduled sync — `POST .../git-sync-overview/disable-scheduled-sync`
- **Disable scheduled sync** button on org git sync overview
- `docs/92-ORG-GIT-BULK-DISABLE-SCHEDULED-SYNC-GUIDE.md`, Phase 24 roadmap
