...
class SamlSsoAdapterTest {

  @Test
  void stubModeStartAndExchangeCode() {
    SamlSsoAdapter adapter = new SamlSsoAdapter(stubProperties(true));
  ...
  @Test
  void nonStubModeFailsFastAtConstruction() {
    assertThrows(IllegalStateException.class, () -> new SamlSsoAdapter(stubProperties(false)));
  }
