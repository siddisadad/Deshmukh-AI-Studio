...
**SLO (Prometheus):** `monitoring/slo-recording-rules.yml` + `slo-alerts.yml` — availability/latency SLIs, error budget alerts, multi-window burn rates, per-tenant SLO — see [docs/42-SLO-ERROR-BUDGET-GUIDE.md](../docs/42-SLO-ERROR-BUDGET-GUIDE.md) and [docs/55-SLO-MULTI-WINDOW-TENANT-GUIDE.md](../docs/55-SLO-MULTI-WINDOW-TENANT-GUIDE.md).
