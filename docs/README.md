...
**MVP beta milestone (2026-08-07):** Phases 0–5 complete on `main`. **v0.2.1-beta** adds thread search, Alertmanager + Loki, and staging dogfood guide — see [CHANGELOG.md](../CHANGELOG.md).
