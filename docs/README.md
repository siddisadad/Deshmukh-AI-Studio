...
**MVP beta milestone (2026-08-07):** Phases 0–5 complete on `main`. **v0.2.111-beta** fixes auth stability and git filter URL deep links — see [CHANGELOG.md](../CHANGELOG.md).
